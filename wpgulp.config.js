...
const textDomain = 'papapiu';

// Name of the translation file.
const translationFile = 'papapiu.pot';

// Where to save the translation files.
const translationDestination = './languages';

// Package name.
const packageName = 'papapiu';

// Where can users report bugs.
const bugReport = 'https://AhmadAwais.com/contact/';

// Last translator Email ID.
const lastTranslator = 'Renan bg_renan@hotmail.com';

// Team's Email ID.
const team = 'Renan bg_renan@hotmail.com';
